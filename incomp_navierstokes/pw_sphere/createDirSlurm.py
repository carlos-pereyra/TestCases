...
storage_path= "meshes/dia_"+diameter+"_len_"+length+"_sep_"+separation+"_ang_"+angle+"/"
...
with open("lam_sphere.cfg",'w') as meshfile:
	...
	meshfile.write("SOLUTION_FLOW_FILENAME= restart_flow.dat\n")
	...
	meshfile.write("WRT_CON_FREQ= 100\n")
...
with open("slurm",'w') as slurmfile:
	...
	slurmfile.write("srun SU2_CFD lam_sphere.cfg\n")
	slurmfile.write("sbatch -d=singleton --job-name={}\n".format(jobname))
	slurmfile.write("SU2_SOL lam_sphere.cfg")
